...
-- /////////////////////////////////////////////////////////////////////////////////////////
--  ( Review Count | RFT | bID | category | date | day of week (1-7) | State | Season )
--     				           (12.4 million rows, .csv) 
-- /////////////////////////////////////////////////////////////////////////////////////////

SELECT COUNT(r.review_id) as reviewCount, r.business_id, c.category_name, DATE(r.review_date) as date, b.state, AVG(rftTemp.avg_daily_foot_traffic) as avg_daily_foot_traffic, rftTemp.DOW,
    CASE 
...
GROUP BY r.business_id, date, rftTemp.DOW, b.state, c.category_name, Season;