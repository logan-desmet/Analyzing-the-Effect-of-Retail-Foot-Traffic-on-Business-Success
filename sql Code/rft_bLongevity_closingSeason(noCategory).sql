-- /////////////////////////////////////////////////////////////////////////////////////////
--  ( bID | Longevity | Open date | Close date | Season Closed | State | RFT )
--                             (138k rows, .csv) 
-- /////////////////////////////////////////////////////////////////////////////////////////

SELECT r.business_id, DATE(min(r.review_date)) as opening_date, DATE(max(r.review_date)) as closing_date, DATEDIFF(Day, min(r.review_date), max(r.review_date)) as longevity_inDays, b.state, AVG(rftTemp.avg_daily_foot_traffic) as avg_retail_foot_traffic,
    CASE 
...
GROUP BY r.business_id, b.state; 
